...
#
def subs(sub, n, m, x_k, x_d, x_l, x_u, g, dg, x_1, dg_1, mov, mov_rel, asy_fac, con_exp, k, s, x_2, L_k, U_k):
#
    if sub == 10:
        [x_p,x_d,dx_l,dx_u]=sub_mma(n,m,x_k,x_d,x_l,x_u,g,dg,mov,mov_rel,asy_fac)
    elif sub == 11:
        [x_p,x_d,dx_l,dx_u,L_k,U_k]=sub_mmaa(n,m,x_k,x_d,x_l,x_u,g,dg,mov,mov_rel,asy_fac,k,s,x_1,x_2,L_k,U_k)
    elif sub == 12:
        [x_p,x_d,dx_l,dx_u]=sub_mma_rel(n,m,x_k,x_d,x_l,x_u,g,dg,mov,mov_rel,asy_fac)
    elif sub == 13:
        [x_p,x_d,dx_l,dx_u,L_k,U_k]=sub_mma_rela(n,m,x_k,x_d,x_l,x_u,g,dg,mov,mov_rel,asy_fac,k,s,x_1,x_2,L_k,U_k)
    elif sub == 20:
