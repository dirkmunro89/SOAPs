...
and hence
\begin{equation}
    \bv[\Delta \bx] = \bc + \partial \bc \cdot \frac {1}{a}  \bx_\bI^{1-a}  \cdot \left( (\bx + \Delta\bx)^a - \bx^a \right)   \:,
\end{equation}
...
\begin{equation}
\bm{\nu}[\Delta \bx] = \bv[\0] + \frac{1}{1!}\partial \bv[\0] \cdot (\bx + \Delta \bx) + \frac{1}{2!}\partial^2 \bv [\0] \cdot (\bx + \Delta \bx)^2 + \frac{1}{3!}\partial^3 \bv[\0] \cdot (\bx + \Delta \bx)^3 + \ldots .
\end{equation}
For sake of simplicity, let us truncate after the first nonlinear (2nd) term
\begin{equation}
\bm{\nu}[\Delta \bx] = \bv[\0] + \partial \bv[\0] \cdot (\bx + \Delta \bx) + \frac{1}{2}\partial^2 \bv[\0] \cdot (\bx + \Delta \bx)^2 \: , 
\end{equation}
